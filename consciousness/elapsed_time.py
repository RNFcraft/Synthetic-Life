...
class CognitElapsedState:
    activity:float;utility:float;activity_trace:float;homeostatic_threshold:float;target_activity:float;last_touch_time:float=0.
    def materialize(self,now,trace_decay,learning_rate,threshold_min,threshold_max,activity_decay,utility_decay):
        ...
        self.homeostatic_threshold=max(threshold_min,min(threshold_max,self.homeostatic_threshold+learning_rate*(trace_sum-self.target_activity*dt)))
