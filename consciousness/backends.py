...
class NativeGraphBackend:
    ...
    def __init__(self,settings):
        ...
        self.engine.set_relation_capacity(settings.max_relations)
    ...
    def process_assembly_bridge(self,graph,cognitive_tick,max_births=None):
        ...
        births=self.settings.max_new_cognits_per_tick if max_births is None else max_births
        rows=self.engine.process_assembly_bridge(cognitive_tick,1,self.settings.max_cognits,births)
