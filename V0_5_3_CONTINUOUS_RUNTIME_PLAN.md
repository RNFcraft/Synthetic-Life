...
- Goal `age`, attempts, interventions, and completion counts remain causal counts. Goal persistence applies the frozen multiplicative factor raised to elapsed seconds; created/unavailable/cooldown timestamps are separate float64 fields.
