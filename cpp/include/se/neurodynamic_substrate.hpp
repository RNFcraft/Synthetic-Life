...
struct AssemblyRecord { std::uint64_t id{}; std::vector<std::uint32_t> members; std::vector<std::array<std::uint32_t,2>> temporal_edges; std::uint32_t support{}; double first_seen{},last_seen{}; bool consolidated{}; };
struct NeuroTelemetry {
  ...
  std::uint64_t assembly_candidates_created{},assemblies_consolidated{},assembly_matches{},assembly_evidence_updates{},max_recent_activity_size{};
...
struct NeuroSnapshot {
  ...
  bool assembly_tracking_enabled{}; double assembly_window{},assembly_decay_tau{}; std::uint32_t assembly_min_support{},assembly_min_members{},assembly_max_members{},assembly_consolidation_support{},next_assembly_id{};
  std::vector<NeuralEvent> recent_spikes; std::vector<AssemblyRecord> assemblies;
...
private:
  ...
  bool assembly_tracking_enabled_{}; double assembly_window_{},assembly_decay_tau_{}; std::uint32_t assembly_min_support_{},assembly_min_members_{},assembly_max_members_{},assembly_consolidation_support_{},next_assembly_id_{};
  ...
  std::vector<NeuralEvent> recent_spikes_; std::vector<AssemblyRecord> assemblies_;
