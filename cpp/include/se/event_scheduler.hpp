...
namespace se {
enum class RuntimeEventType:std::uint8_t { WorldActionComplete=1,WorldSpawn,SensoryChange,CognitionWake,CognitionContinue,MemoryTimer,RelationTimer,Maintenance,ExternalInput,LanguageInput };
